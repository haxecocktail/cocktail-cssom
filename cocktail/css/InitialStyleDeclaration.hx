...
{
    private static inline var DEFAULT_FONT = "serif";
    
    private static inline var DEFAULT_FONT_COLOR = "#000000";

    private static inline var MEDIUM_BORDER_WIDTH:Int = 3;
    ...
    private function initProperties():Void
    {
        ...
        pushProperty(CSSConstants.BORDER_TOP_COLOR, COLOR(CSSColorValue.HEX(DEFAULT_FONT_COLOR)));
        pushProperty(CSSConstants.BORDER_RIGHT_COLOR, COLOR(CSSColorValue.HEX(DEFAULT_FONT_COLOR)));
        pushProperty(CSSConstants.BORDER_BOTTOM_COLOR,COLOR(CSSColorValue.HEX(DEFAULT_FONT_COLOR)));
        pushProperty(CSSConstants.BORDER_LEFT_COLOR, COLOR(CSSColorValue.HEX(DEFAULT_FONT_COLOR)));
        ...
        pushProperty(CSSConstants.FONT_FAMILY, CSS_LIST([STRING(DEFAULT_FONT)]));
        pushProperty(CSSConstants.COLOR, COLOR(CSSColorValue.HEX(DEFAULT_FONT_COLOR)));
    }
    ...
    private function initComputedProperties():Void
    {
        ...
        pushComputedProperty(CSSConstants.BORDER_TOP_WIDTH, ABSOLUTE_LENGTH(MEDIUM_BORDER_WIDTH));
        pushComputedProperty(CSSConstants.BORDER_RIGHT_WIDTH, ABSOLUTE_LENGTH(MEDIUM_BORDER_WIDTH));
        pushComputedProperty(CSSConstants.BORDER_BOTTOM_WIDTH, ABSOLUTE_LENGTH(MEDIUM_BORDER_WIDTH));
        pushComputedProperty(CSSConstants.BORDER_LEFT_WIDTH, ABSOLUTE_LENGTH(MEDIUM_BORDER_WIDTH));
        
        pushComputedProperty(CSSConstants.BORDER_TOP_COLOR, COLOR(CSSColorValue.HEX(DEFAULT_FONT_COLOR)));
        pushComputedProperty(CSSConstants.BORDER_RIGHT_COLOR, COLOR(CSSColorValue.HEX(DEFAULT_FONT_COLOR)));
        pushComputedProperty(CSSConstants.BORDER_BOTTOM_COLOR,COLOR(CSSColorValue.HEX(DEFAULT_FONT_COLOR)));
        pushComputedProperty(CSSConstants.BORDER_LEFT_COLOR, COLOR(CSSColorValue.HEX(DEFAULT_FONT_COLOR)));
        ...
        pushComputedProperty(CSSConstants.OUTLINE_WIDTH, ABSOLUTE_LENGTH(MEDIUM_BORDER_WIDTH));
